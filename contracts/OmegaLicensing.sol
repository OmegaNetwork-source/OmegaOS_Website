...
contract OmegaLicensing {
    ...
    // Treasury address - receives purchased license payments
    ...
    constructor(
        ...
        owner = msg.sender;
        treasury = _treasury != address(0) ? _treasury : msg.sender; // Default to owner if not specified
        ...
        validOmegaId(omegaId) 
    {
        ...
        // Transfer purchase amount to treasury
        payable(treasury).transfer(purchaseAmount);
     ...
     * @dev This is mainly for withdrawing any remaining staked tokens or excess funds
     */
